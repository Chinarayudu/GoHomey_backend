...
let MealsController = class MealsController {
    ...
    create(req, createMealDto) {
        return this.mealsService.create(req.user.chefId || req.user.id, createMealDto);
    }
    findAll(date, chefId) {
    ...
    update(id, req, updateMealDto) {
        return this.mealsService.update(id, req.user.chefId || req.user.id, updateMealDto);
    }
    remove(id, req) {
...
__decorate([
    ...
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new daily meal (Chef only)' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all daily meals' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get a specific meal by ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a meal (Chef only)' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Request)()),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, meals_dto_1.UpdateMealDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete a meal (Chef only)' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
